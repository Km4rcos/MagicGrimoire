...
const styles = {
  ...
  input: { flex:2, minWidth:'200px', padding:'0.75rem', borderRadius:'4px', border:'1px solid rgba(212, 175, 55, 0.3)', background:'var(--bg-card)', color:'var(--text-main)', fontSize:'1rem', fontFamily:'var(--font-sans)' },
  select: { flex:1, minWidth:'150px', padding:'0.75rem', borderRadius:'4px', border:'1px solid rgba(212, 175, 55, 0.3)', background:'var(--bg-card)', color:'var(--text-main)', fontSize:'1rem', cursor:'pointer', fontFamily:'var(--font-sans)' },
